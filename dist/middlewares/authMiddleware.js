...
const hasRole = (...roles) => [
    ...
    (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const user = yield User_1.User.findById((_a = req.user) === null || _a === void 0 ? void 0 : _a.id).populate('role');
...
const hasPermission = (permissions) => [
    ...
    (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const user = yield User_1.User.findById((_a = req.user) === null || _a === void 0 ? void 0 : _a.id).populate({
            path: 'role',
        ...
        const userPermissions = (user === null || user === void 0 ? void 0 : user.role).permissions.map((p) => p.name);
