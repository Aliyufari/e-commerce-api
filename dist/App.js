        ...
        this.app.use(async (req, res, next) => {
            try {
                ...
                res.status(HttpStatusCode_1.HttpStatusCode.INTERNAL_SERVER_ERROR)
                    .json(new ApiResponse_1.ApiResponse(HttpStatusCode_1.HttpStatusCode.INTERNAL_SERVER_ERROR, HttpStatus_1.HttpStatus.INTERNAL_SERVER_ERROR, 'Database connection error'));
            }
        });
    }
    routes() {
